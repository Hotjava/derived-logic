...
require_once("include/calyearly_variables.php");
...
$layout = new TLayout("list31", "Coral1Coral", "MobileCoral");
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "calyearly_list";
$layout->blocks["center"] = array();
$layout->containers["grid"] = array();
$layout->container_properties["grid"] = array(  );
$layout->containers["grid"][] = array("name"=>"",
	"block"=>"", "substyle"=>1  );
...
$page_layouts["calyearly_list"] = $layout;
