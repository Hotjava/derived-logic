...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "calcalendar" ] = array( "url" => "calcalendar", "type" => 1 );
	$projectEntitiesReverse[ "calcalendar" ] = "calcalendar";
	$projectEntities[ "calcategory" ] = array( "url" => "calcategory", "type" => 1 );
	$projectEntitiesReverse[ "calcategory" ] = "calcategory";
	$projectEntities[ "caldaily" ] = array( "url" => "caldaily", "type" => 1 );
	$projectEntitiesReverse[ "caldaily" ] = "caldaily";
	$projectEntities[ "calmonthly" ] = array( "url" => "calmonthly", "type" => 1 );
	$projectEntitiesReverse[ "calmonthly" ] = "calmonthly";
	$projectEntities[ "calweekly" ] = array( "url" => "calweekly", "type" => 1 );
	$projectEntitiesReverse[ "calweekly" ] = "calweekly";
	$projectEntities[ "calglobals" ] = array( "url" => "calglobals", "type" => 1 );
	$projectEntitiesReverse[ "calglobals" ] = "calglobals";
	$projectEntities[ "calyearly" ] = array( "url" => "calyearly", "type" => 1 );
	$projectEntitiesReverse[ "calyearly" ] = "calyearly";
	$projectEntities[ "calusers" ] = array( "url" => "calusers", "type" => 1 );
	$projectEntitiesReverse[ "calusers" ] = "calusers";
	$projectEntities[ "calholidays" ] = array( "url" => "calholidays", "type" => 1 );
	$projectEntitiesReverse[ "calholidays" ] = "calholidays";
	$projectEntities[ "calweekdays" ] = array( "url" => "calweekdays", "type" => 1 );
	$projectEntitiesReverse[ "calweekdays" ] = "calweekdays";
	$projectEntities[ "vendors" ] = array( "url" => "vendors", "type" => 0 );
	$projectEntitiesReverse[ "vendors" ] = "vendors";
	$projectEntities[ "terms" ] = array( "url" => "terms", "type" => 0 );
	$projectEntitiesReverse[ "terms" ] = "terms";
	$projectEntities[ "customers" ] = array( "url" => "customers", "type" => 0 );
	$projectEntitiesReverse[ "customers" ] = "customers";
	$projectEntities[ "renewal_types" ] = array( "url" => "renewal_types", "type" => 0 );
	$projectEntitiesReverse[ "renewal_types" ] = "renewal_types";
	$projectEntities[ "vendor_contacts" ] = array( "url" => "vendor_contacts", "type" => 0 );
	$projectEntitiesReverse[ "vendor_contacts" ] = "vendor_contacts";
	$projectEntities[ "sourcing_contacts" ] = array( "url" => "sourcing_contacts", "type" => 0 );
	$projectEntitiesReverse[ "sourcing_contacts" ] = "sourcing_contacts";
	$projectEntities[ "ops_contacts" ] = array( "url" => "ops_contacts", "type" => 0 );
	$projectEntitiesReverse[ "ops_contacts" ] = "ops_contacts";
	$projectEntities[ "renewals" ] = array( "url" => "renewals", "type" => 0 );
	$projectEntitiesReverse[ "renewals" ] = "renewals";
	$projectEntities[ "Renewals Due 90 Days" ] = array( "url" => "Renewals_Due_90_Days", "type" => 2 );
	$projectEntitiesReverse[ "Renewals_Due_90_Days" ] = "Renewals Due 90 Days";
	$projectEntities[ "Upcoming Top 5 Vendor Spend" ] = array( "url" => "Upcoming_Top_5_Vendor_Spend", "type" => 2 );
	$projectEntitiesReverse[ "Upcoming_Top_5_Vendor_Spend" ] = "Upcoming Top 5 Vendor Spend";
	$projectEntities[ "Spend Per Customer" ] = array( "url" => "Spend_Per_Customer", "type" => 2 );
	$projectEntitiesReverse[ "Spend_Per_Customer" ] = "Spend Per Customer";
	$projectEntities[ "Dashboard" ] = array( "url" => "Dashboard", "type" => 4 );
	$projectEntitiesReverse[ "Dashboard" ] = "Dashboard";
	$projectEntities[ "license_keys" ] = array( "url" => "license_keys", "type" => 0 );
	$projectEntitiesReverse[ "license_keys" ] = "license_keys";
	$projectEntities[ "products" ] = array( "url" => "products", "type" => 0 );
	$projectEntitiesReverse[ "products" ] = "products";
	$projectEntities[ "product_types" ] = array( "url" => "product_types", "type" => 0 );
	$projectEntitiesReverse[ "product_types" ] = "product_types";
	$projectEntities[ "status" ] = array( "url" => "status", "type" => 0 );
	$projectEntitiesReverse[ "status" ] = "status";
}
