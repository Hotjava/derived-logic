...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("calweekdays" == $this->chrt_array['tables'][0])
			return true;
		if("vendors" == $this->chrt_array['tables'][0])
			return true;
		if("terms" == $this->chrt_array['tables'][0])
			return true;
		if("customers" == $this->chrt_array['tables'][0])
			return true;
		if("renewal_types" == $this->chrt_array['tables'][0])
			return true;
		if("vendor_contacts" == $this->chrt_array['tables'][0])
			return true;
		if("sourcing_contacts" == $this->chrt_array['tables'][0])
			return true;
		if("ops_contacts" == $this->chrt_array['tables'][0])
			return true;
		if("renewals" == $this->chrt_array['tables'][0])
			return true;
		if("renewals" == $this->chrt_array['tables'][0])
			return true;
		if("renewals" == $this->chrt_array['tables'][0])
		...
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("license_keys" == $this->chrt_array['tables'][0])
			return true;
		if("products" == $this->chrt_array['tables'][0])
			return true;
		if("product_types" == $this->chrt_array['tables'][0])
			return true;
		if("status" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
