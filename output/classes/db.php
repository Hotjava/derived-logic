...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "Tables" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "calcalendar", "varname" => "Tables__calcalendar", "altvarname" => "calcalendar", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "calcategory", "varname" => "Tables__calcategory", "altvarname" => "calcategory", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "calfirstday", "varname" => "Tables__calfirstday", "altvarname" => "calfirstday", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "calglobals", "varname" => "Tables__calglobals", "altvarname" => "calglobals", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "calholidays", "varname" => "Tables__calholidays", "altvarname" => "calholidays", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "calperiod", "varname" => "Tables__calperiod", "altvarname" => "calperiod", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "calusers", "varname" => "Tables__calusers", "altvarname" => "calusers", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "calweekdays", "varname" => "Tables__calweekdays", "altvarname" => "calweekdays", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "customers", "varname" => "Tables__customers", "altvarname" => "customers", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "license_keys", "varname" => "Tables__license_keys", "altvarname" => "license_keys", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "ops_contacts", "varname" => "Tables__ops_contacts", "altvarname" => "ops_contacts", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "product_types", "varname" => "Tables__product_types", "altvarname" => "product_types", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "products", "varname" => "Tables__products", "altvarname" => "products", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "renewal_types", "varname" => "Tables__renewal_types", "altvarname" => "renewal_types", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "renewals", "varname" => "Tables__renewals", "altvarname" => "renewals", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "sourcing_contacts", "varname" => "Tables__sourcing_contacts", "altvarname" => "sourcing_contacts", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "status", "varname" => "Tables__status", "altvarname" => "status", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "terms", "varname" => "Tables__terms", "altvarname" => "terms", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "vendor_contacts", "varname" => "Tables__vendor_contacts", "altvarname" => "vendor_contacts", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
			$dalTables[$conn->connId][] = array("name" => "vendors", "varname" => "Tables__vendors", "altvarname" => "vendors", "connId" => "Tables", "schema" => "", "connName" => "CC AZD Demo at localhost");
		}
	}
