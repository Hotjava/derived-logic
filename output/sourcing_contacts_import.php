...
$layout = new TLayout("import_bootstrap", "Coral1Coral", "MobileCoral");
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "sourcing_contacts_import";
...
$page_layouts["sourcing_contacts_import"] = $layout;
