...
require_once("include/ops_contacts_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "ops_contacts_add";
...
$page_layouts["ops_contacts_add"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "ops_contacts_list";
...
$page_layouts["ops_contacts_list"] = $layout;
