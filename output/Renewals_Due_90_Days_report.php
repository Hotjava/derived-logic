...
require_once("include/Renewals_Due_90_Days_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "Renewals_Due_90_Days_report";
...
$page_layouts["Renewals_Due_90_Days_report"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "renewals_masterlist";
...
$page_layouts["renewals_masterlist"] = $layout;
