...
require_once("include/terms_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "terms_add";
...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "terms_list";
...
$page_layouts["terms_list"] = $layout;
