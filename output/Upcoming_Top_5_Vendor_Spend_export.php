...
$layout = new TLayout("export_bootstrap", "Coral1Coral", "MobileCoral");
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "Upcoming_Top_5_Vendor_Spend_export";
...
$page_layouts["Upcoming_Top_5_Vendor_Spend_export"] = $layout;
