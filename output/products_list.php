...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "products_list";
...
$page_layouts["products_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "product_types_masterlist";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterlistheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["product_types_masterlist"] = $layout;
