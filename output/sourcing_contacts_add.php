...
require_once("include/sourcing_contacts_variables.php");
...
$layout = new TLayout("add_bootstrap", "Coral1Coral", "MobileCoral");
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "sourcing_contacts_add";
...
$page_layouts["sourcing_contacts_add"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "sourcing_contacts_list";
...
$page_layouts["sourcing_contacts_list"] = $layout;
