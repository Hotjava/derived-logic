...
function checkTableName($shortTName, $type=false)
{
	...
	if ("calcalendar" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("calcategory" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("caldaily" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("calmonthly" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("calweekly" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("calglobals" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("calyearly" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("calusers" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("calholidays" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("calweekdays" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("vendors" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("terms" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("customers" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("renewal_types" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("vendor_contacts" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("sourcing_contacts" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ops_contacts" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("renewals" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Renewals_Due_90_Days" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Upcoming_Top_5_Vendor_Spend" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Spend_Per_Customer" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Dashboard" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("license_keys" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("products" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("product_types" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$strPerm = GetUserPermissions("caldaily");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="caldaily";
	}
	$strPerm = GetUserPermissions("calmonthly");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="calmonthly";
	}
	$strPerm = GetUserPermissions("calweekly");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="calweekly";
	}
	...
	$strPerm = GetUserPermissions("calyearly");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="calyearly";
	}
	...
	$strPerm = GetUserPermissions("vendors");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="vendors";
	}
	$strPerm = GetUserPermissions("terms");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="terms";
	}
	$strPerm = GetUserPermissions("customers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="customers";
	}
	$strPerm = GetUserPermissions("renewal_types");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="renewal_types";
	}
	$strPerm = GetUserPermissions("vendor_contacts");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="vendor_contacts";
	}
	$strPerm = GetUserPermissions("sourcing_contacts");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="sourcing_contacts";
	}
	$strPerm = GetUserPermissions("ops_contacts");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ops_contacts";
	}
	$strPerm = GetUserPermissions("renewals");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="renewals";
	}
	$strPerm = GetUserPermissions("Renewals Due 90 Days");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Renewals Due 90 Days";
	}
	$strPerm = GetUserPermissions("Upcoming Top 5 Vendor Spend");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Upcoming Top 5 Vendor Spend";
	}
	$strPerm = GetUserPermissions("Spend Per Customer");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Spend Per Customer";
	}
	...
	$strPerm = GetUserPermissions("license_keys");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="license_keys";
	}
	$strPerm = GetUserPermissions("products");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="products";
	}
	$strPerm = GetUserPermissions("product_types");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="product_types";
	}
	$strPerm = GetUserPermissions("status");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="status";
	}
...
function GetUserPermissionsStatic( $table )
{
	...
	if($table=="calcalendar" && $sUserGroup=="0")
	{
			return "AEDSP".$extraPerm;
	}
	if($table=="calcalendar" && $sUserGroup=="admin")
	{
			return "AEDSP".$extraPerm;
	}
//	default permissions
	...
	if($table=="calcategory" && $sUserGroup=="0")
	{
			return "AEDSP".$extraPerm;
	}
	if($table=="calcategory" && $sUserGroup=="admin")
	{
			return "AEDSP".$extraPerm;
	}
//	default permissions
	...
	if($table=="caldaily" && $sUserGroup=="0")
	{
			return "AEDSP".$extraPerm;
	}
	if($table=="caldaily" && $sUserGroup=="admin")
	{
			return "AEDSP".$extraPerm;
	}
//	default permissions
	...
	if($table=="calmonthly" && $sUserGroup=="0")
	{
			return "AEDSP".$extraPerm;
	}
	if($table=="calmonthly" && $sUserGroup=="admin")
	{
			return "AEDSP".$extraPerm;
	}
//	default permissions
	...
	if($table=="calweekly" && $sUserGroup=="0")
	{
			return "AEDSP".$extraPerm;
	}
	if($table=="calweekly" && $sUserGroup=="admin")
	{
			return "AEDSP".$extraPerm;
	}
//	default permissions
	...
	if($table=="calglobals" && $sUserGroup=="0")
	{
			return "AEDSP".$extraPerm;
	}
	if($table=="calglobals" && $sUserGroup=="admin")
	{
			return "AEDSP".$extraPerm;
	}
//	default permissions
	...
	if($table=="calyearly" && $sUserGroup=="0")
	{
			return "AEDSP".$extraPerm;
	}
	if($table=="calyearly" && $sUserGroup=="admin")
	{
			return "AEDSP".$extraPerm;
	}
//	default permissions
	...
	if($table=="calusers" && $sUserGroup=="0")
	{
			return "AEDSP".$extraPerm;
	}
	if($table=="calusers" && $sUserGroup=="admin")
	{
			return "AEDSP".$extraPerm;
	}
//	default permissions
	...
	if($table=="calholidays" && $sUserGroup=="0")
	{
			return "AEDSP".$extraPerm;
	}
	if($table=="calholidays" && $sUserGroup=="admin")
	{
			return "AEDSP".$extraPerm;
	}
//	default permissions
	...
	if($table=="calweekdays" && $sUserGroup=="0")
	{
			return "AEDSP".$extraPerm;
	}
	if($table=="calweekdays" && $sUserGroup=="admin")
	{
			return "AEDSP".$extraPerm;
	}
//	default permissions
	...
	if($table=="vendors" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="vendors" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="terms" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="terms" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="customers" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="customers" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="renewal_types" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="renewal_types" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="renewal_types")
	{
		return "S".$extraPerm;
	}
	if($table=="vendor_contacts" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="vendor_contacts" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="sourcing_contacts" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="sourcing_contacts" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="sourcing_contacts")
	{
		return "S".$extraPerm;
	}
	if($table=="ops_contacts" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="ops_contacts" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="ops_contacts")
	{
		return "S".$extraPerm;
	}
	if($table=="renewals" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="renewals" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="Renewals Due 90 Days" && $sUserGroup=="0")
	{
			return "SP".$extraPerm;
	}
	if($table=="Renewals Due 90 Days" && $sUserGroup=="admin")
	{
			return "SP".$extraPerm;
	}
//	default permissions
	if($table=="Renewals Due 90 Days")
	{
		return "S".$extraPerm;
	}
	if($table=="Upcoming Top 5 Vendor Spend" && $sUserGroup=="0")
	{
			return "SP".$extraPerm;
	}
	if($table=="Upcoming Top 5 Vendor Spend" && $sUserGroup=="admin")
	{
			return "SP".$extraPerm;
	}
//	default permissions
	if($table=="Upcoming Top 5 Vendor Spend")
	{
		return "S".$extraPerm;
	}
	if($table=="Spend Per Customer" && $sUserGroup=="0")
	{
			return "SP".$extraPerm;
	}
	if($table=="Spend Per Customer" && $sUserGroup=="admin")
	{
			return "SP".$extraPerm;
	}
//	default permissions
	if($table=="Spend Per Customer")
	{
		return "S".$extraPerm;
	}
	if($table=="Dashboard" && $sUserGroup=="0")
	{
			return "S".$extraPerm;
	}
	if($table=="Dashboard" && $sUserGroup=="admin")
	{
			return "S".$extraPerm;
	}
//	default permissions
	...
	if($table=="license_keys" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="license_keys" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="products" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="products" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="product_types" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="product_types" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="status" && $sUserGroup=="0")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="status" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
...
function AfterFBLogIn( $pUsername, $pPassword, $pDisplayUsername, &$pageObject = null)
{
	...
	$strSQL = "select * from ".$connection->addTableWrappers("calusers")
...
function SetAuthSessionData($pUsername, &$data, $fromFacebook, $password, &$pageObject = null, $fireEvents = true )
{
	...
	$_SESSION["_calcalendar_OwnerID"] = $data["username"];
		$_SESSION["_caldaily_OwnerID"] = $data["username"];
		$_SESSION["_calmonthly_OwnerID"] = $data["username"];
		$_SESSION["_calweekly_OwnerID"] = $data["username"];
		$_SESSION["_calyearly_OwnerID"] = $data["username"];
