...
require_once("include/status_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "status_add";
...
$page_layouts["status_add"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "spacelab";
		$layout->customCssPageName = "status_list";
...
$page_layouts["status_list"] = $layout;
