...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["dbType"] = 0;
		$data["connId"] = "Tables";
		$data["connName"] = "CC AZD Demo at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;devuser;Port:21;;calendar;https://corinium-core-dev.software-asset-manager.com/phprunner.php;0"; //currently unused

		$this->_connectionsIdByName["CC AZD Demo at localhost"] = "Tables";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "devuser";
		$data["ODBCPWD"] = "Port:21";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		
		$data["DBPath"] = "db"; //currently unused	
		$data["useServerMapPath"] = 0; //currently unused
		
		$data["connInfo"][0] = "localhost";
		$data["connInfo"][1] = "devuser";
		$data["connInfo"][2] = "Port:21";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "calendar";
		$data["connInfo"][5] = "https://corinium-core-dev.software-asset-manager.com/phprunner.php"; //currently unused
		$data["connInfo"][6] = "0"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=devuser;Pwd=Port:21;Database=calendar;OPTION=3";
		// encription set
	...
	{
		$connectionsIds = array();
		$connectionsIds["calcalendar"] = "Tables";
		$connectionsIds["calcategory"] = "Tables";
		$connectionsIds["caldaily"] = "Tables";
		$connectionsIds["calmonthly"] = "Tables";
		$connectionsIds["calweekly"] = "Tables";
		$connectionsIds["calglobals"] = "Tables";
		$connectionsIds["calyearly"] = "Tables";
		$connectionsIds["calusers"] = "Tables";
		$connectionsIds["calholidays"] = "Tables";
		$connectionsIds["calweekdays"] = "Tables";
		$connectionsIds["vendors"] = "Tables";
		$connectionsIds["terms"] = "Tables";
		$connectionsIds["customers"] = "Tables";
		$connectionsIds["renewal_types"] = "Tables";
		$connectionsIds["vendor_contacts"] = "Tables";
		$connectionsIds["sourcing_contacts"] = "Tables";
		$connectionsIds["ops_contacts"] = "Tables";
		$connectionsIds["renewals"] = "Tables";
		$connectionsIds["Renewals Due 90 Days"] = "Tables";
		$connectionsIds["Upcoming Top 5 Vendor Spend"] = "Tables";
		$connectionsIds["Spend Per Customer"] = "Tables";
		$connectionsIds["license_keys"] = "Tables";
		$connectionsIds["products"] = "Tables";
		$connectionsIds["product_types"] = "Tables";
		$connectionsIds["status"] = "Tables";
