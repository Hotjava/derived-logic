...
$layout = new TLayout("Calendarcalweekly_print", "Coral1Coral", "MobileCoral");
$layout->version = 2;
...
$page_layouts["calweekly_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "calweekly" );
